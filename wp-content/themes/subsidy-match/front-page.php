...
<main>
    ...
    (function() {
        var cases = [
            ...
            { ind: '宿泊業', sub: '事業再構築補助金', amt: '1,500万円', use: 'ワーケーション施設へのリノベーション' },
            // 小売
            { ind: '小売業', sub: 'IT導入補助金', amt: '300万円', use: 'POSレジ＋在庫管理クラウド導入' },
            { ind: '小売業', sub: '持続化補助金', amt: '50万円', use: 'ECサイト構築・SNS広告' },
            { ind: '小売業', sub: '省力化投資補助金', amt: '400万円', use: 'セルフレジ・無人決済システム導入' },
            // 飲食
            { ind: '飲食業', sub: 'IT導入補助金', amt: '150万円', use: 'モバイルオーダー・POSシステム導入' },
            { ind: '飲食業', sub: '持続化補助金', amt: '50万円', use: 'テイクアウト用ECサイト構築' },
            { ind: '飲食業', sub: '事業再構築補助金', amt: '1,000万円', use: 'セントラルキッチン＋デリバリー事業展開' },
            // 不動産
            { ind: '不動産業', sub: 'IT導入補助金', amt: '250万円', use: '物件管理・内見予約システム導入' },
            { ind: '不動産業', sub: '持続化補助金', amt: '50万円', use: 'VR内見・ポータルサイト連携' },
            // 教育
            { ind: '教育・学習支援', sub: 'IT導入補助金', amt: '200万円', use: 'オンライン授業・学習管理システム導入' },
            { ind: '教育・学習支援', sub: '持続化補助金', amt: '50万円', use: 'Web集客・LINE公式アカウント構築' },
            { ind: '教育・学習支援', sub: '省力化投資補助金', amt: '300万円', use: 'AI教材・成績分析ダッシュボード導入' },
            // 美容
            { ind: '美容業', sub: 'IT導入補助金', amt: '150万円', use: '予約管理・顧客管理システム導入' },
            { ind: '美容業', sub: '持続化補助金', amt: '50万円', use: 'Instagram集客・LINE予約連携' },
            // 士業
            { ind: '士業・専門サービス', sub: 'IT導入補助金', amt: '150万円', use: '案件管理・電子契約システム導入' },
            { ind: '士業・専門サービス', sub: '持続化補助金', amt: '50万円', use: 'Webマーケティング・SEO対策' },
            // サービス業
            { ind: 'サービス業', sub: 'IT導入補助金', amt: '200万円', use: '予約・顧客管理クラウド導入' },
            { ind: 'サービス業', sub: '持続化補助金', amt: '50万円', use: 'ホームページ制作・Google広告' },
            { ind: 'サービス業', sub: '省力化投資補助金', amt: '350万円', use: 'クリーニング自動仕分け・受付無人化' },
            // 卸売
            { ind: '卸売業', sub: 'IT導入補助金', amt: '300万円', use: '受発注クラウド・在庫最適化AI導入' },
            { ind: '卸売業', sub: 'ものづくり補助金', amt: '750万円', use: '冷凍設備自動化・品質管理IoT導入' },
        ];
        // シャッフル
